...
## **Archivos sql**
Se crearon tablas para importar los csv y hacer los cambios que requerian hacer en sql (los marcados en ETL.ipynb para hacer en SQL).<br>
Se hacen las conexiones para exportar el database de mysql y que ya lo exporte con sus conexiones 
